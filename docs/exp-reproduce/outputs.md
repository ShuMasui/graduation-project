...
| **Step 5** | [`modules/step5_stats_visualization`](file:///Users/shumasui/Documents/school/graduate-project/exp-reproduce/modules/step5_stats_visualization) | ベクトル化置換検定 (10,000回) & グラフ描画 | 6 tests / PASS |
...
**単体テスト総合結果**: **36 / 36 テスト合格 (100% PASS)**
...
- [ ] 解剖テンプレート（事前計算済み FreeSurfer `subjects/icbm152/` フォルダ）の配置
- [ ] CerebrA NIfTI 画像（`CerebrA.nii`）の配置
